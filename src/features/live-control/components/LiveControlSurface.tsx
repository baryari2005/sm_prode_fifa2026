...
export const LIVE_CONTROL_SURFACE_CLASSNAME =
...
export const LIVE_CONTROL_SUBCARD_CLASSNAME =
  "rounded-[24px] border border-white/10 bg-white/[0.05] shadow-[inset_0_1px_0_rgba(255,255,255,0.04)]";

export const LIVE_CONTROL_INPUT_CLASSNAME =
  "border-white/10 bg-white/[0.08] text-white placeholder:text-white/35 focus-visible:border-[#5993B6]/45 focus-visible:ring-[#5993B6]/30";

export const LIVE_CONTROL_TEXTAREA_CLASSNAME =
  "min-h-[96px] rounded-2xl border-white/10 bg-white/[0.08] px-4 py-3 text-white placeholder:text-white/35 shadow-none focus-visible:border-[#5993B6]/45 focus-visible:ring-[#5993B6]/30";

export const LIVE_CONTROL_SECONDARY_BUTTON_CLASSNAME =
  "rounded-2xl border border-[#5993B6]/24 bg-white/[0.06] text-white shadow-none hover:bg-white/[0.1] hover:text-white";

export const LIVE_CONTROL_CRITICAL_BUTTON_CLASSNAME =
  "rounded-2xl border border-rose-300/18 bg-rose-500/12 text-rose-100 shadow-none hover:bg-rose-500/18 hover:text-white";

export const LIVE_CONTROL_STATUS_BADGE_CLASSNAME =
  "rounded-full border border-[#5993B6]/20 bg-[#5993B6]/10 text-[#AEEBFF] hover:bg-[#5993B6]/10";
...
export function LiveControlSurface({
  ...
  return (
    <section className={cn(LIVE_CONTROL_SURFACE_CLASSNAME, className)}>

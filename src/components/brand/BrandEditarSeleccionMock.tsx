...
export function BrandEditarSeleccionMock() {
  return (
    <BrandPageShell
        ...
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            ...
            <p className="mt-1 text-sm text-[#1E2C46]/72">
              Preview aislada para validar la pantalla de editar selección.
            </p>
          </div>

          <Link
            href="/brand-preview/selecciones"
      ...
      <section className={`${DASHBOARD_PANEL} rounded-[32px] p-3 md:p-4`}>
        ...
        <div className="grid w-full min-w-0 gap-4 2xl:grid-cols-[minmax(0,2.05fr)_minmax(300px,0.95fr)] 2xl:items-stretch">
          <section className="relative h-full w-full min-w-0 overflow-hidden rounded-[30px] border border-white/10 bg-[#1E2C46] px-4 py-5 text-white shadow-[0_24px_70px_rgba(2,6,23,0.24)] md:px-6 md:py-6 xl:px-7 xl:py-6 2xl:h-[420px] 2xl:px-8 2xl:py-7">
            ...
            <div className="relative z-10 flex h-full max-w-[62%] min-w-0 flex-col">
              ...
              <div className="mt-6 space-y-2.5 xl:mt-8">
                ...
                <p className="font-brand max-w-[540px] text-[1.9rem] font-semibold leading-[0.96] tracking-[0.04em] text-white md:text-[2rem] xl:text-[2.25rem] 2xl:text-[2.55rem]">
                  Edita datos, bandera y accesos del plantel
                </p>

                <p className="max-w-[470px] pt-2 text-[0.95rem] leading-5 text-white/78 xl:text-[1rem]">
                  Una pantalla editorial para actualizar la selección, validar su
                  identidad visual y saltar rápido a plantel o configuraciones relacionadas.
                </p>
              </div>
              ...
              <div className="flex flex-wrap gap-3 pt-8 xl:pt-10 2xl:pt-14">
                ...
                <Link href="/brand-preview/planteles">
                  <Button
                    variant="outline"
                    className="rounded-2xl border-white/15 bg-white/10 text-white hover:bg-white/15"
                  >
            ...
            <div className="pointer-events-none absolute bottom-[-24px] right-[-12px] z-20 hidden h-[430px] w-[360px] xl:block 2xl:bottom-[-28px] 2xl:right-[-8px] 2xl:h-[520px] 2xl:w-[420px]">
              ...
              <Image
                ...
                className="relative object-contain object-[center_bottom] opacity-72 drop-shadow-[0_28px_64px_rgba(0,0,0,0.34)] [mask-image:radial-gradient(circle_at_center,rgba(0,0,0,0.98)_44%,rgba(0,0,0,0.82)_62%,rgba(0,0,0,0.42)_82%,transparent_100%)] [-webkit-mask-image:radial-gradient(circle_at_center,rgba(0,0,0,0.98)_44%,rgba(0,0,0,0.82)_62%,rgba(0,0,0,0.42)_82%,transparent_100%)]"
              />
            </div>
          </section>
            ...
            <div className="mb-3">
              ...
              <p className="mt-1.5 flex items-start justify-center gap-2 text-center text-sm font-semibold leading-5 text-white/68">
                ...
                <span className="max-w-[260px]">
                  Resumen rápido de la selección antes de guardar cambios.
                </span>
              </p>
            </div>
          ...
          <div className="relative z-10 space-y-5">
            <div>
              ...
              <p className="mt-2 max-w-[760px] text-sm leading-6 text-white/72">
                El mock mantiene la lógica del form real, pero con un lenguaje visual
                alineado al dashboard aprobado.
              </p>
            </div>

            <div className="grid gap-4 md:grid-cols-[240px_minmax(0,1fr)]">
              <div className={`rounded-[28px] p-4 ${DASHBOARD_SUBCARD}`}>
                <p className="text-[10px] font-black uppercase tracking-[0.2em] text-[#AEEBFF]">
                  Identidad visual
                </p>
                <div className="mt-4 flex flex-col items-center gap-4 text-center">
                  <div className="flex h-28 w-28 items-center justify-center rounded-[28px] border border-white/12 bg-white/10">
                    <FlagImage
                      bandera=""
                      codigo="ARG"
                      nombre="Argentina"
                  ...
                  <div>
                    <p className="font-brand text-[1.4rem] leading-none tracking-[0.04em] text-white">
                      Grupo A
                    </p>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className={`rounded-[28px] p-4 ${DASHBOARD_SUBCARD}`}>
                  ...
                  <Input
                    value="Argentina"
                    readOnly
                    className="mt-3 h-11 rounded-2xl border-white/10 bg-white/8 text-white"
                  />
                </div>
              ...
              <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                <div>
                  ...
                  <p className="mt-2 text-sm leading-6 text-white/72">
                    En la implementación real, acá viviría la subida de imagen con drag and drop.
                  </p>
                </div>
        ...
        <div className="space-y-4">
          <section className={`${DASHBOARD_PANEL} rounded-[32px] p-4 md:p-5`}>
            ...
            <div className="relative z-10 space-y-4">
              ...
              <div className="space-y-3">
                {[
                  "Administrar plantel",
                  "Ver selección pública",
                  "Actualizar desde la API",
                ].map((action) => (
                  <div key={action} className={`rounded-2xl p-4 ${DASHBOARD_SUBCARD}`}>
                    <p className="text-sm font-semibold text-white">{action}</p>
                    <p className="mt-1 text-sm text-white/64">
                      CTA lateral con el mismo comportamiento que el dashboard.
                    </p>
                  </div>
                ))}
              </div>
          ...
          <section className={`${DASHBOARD_PANEL} rounded-[32px] p-4 md:p-5`}>
            ...
            <div className="relative z-10 space-y-4">
              ...
              <div className="space-y-3">
                {[
                  "Hero idéntico en lógica al overview aprobado.",
                  "Formulario principal con subcards oscuras y aire visual.",
                  "Lateral con métricas y accesos sin competir con el form.",
                  "Preparado para migrar luego a la pantalla real.",
                ].map((idea) => (
